...
export interface ApiDeletAccountDeletAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'delet_accounts';
  info: {
    displayName: 'DeletAccount';
    pluralName: 'delet-accounts';
    singularName: 'delet-account';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::delet-account.delet-account'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::delet-account.delet-account': ApiDeletAccountDeletAccount;
